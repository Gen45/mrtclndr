...
class Filters extends Component {
  ...
  render() {
    ...
    return (<div className={`filter ${this.state.collapsed
              ...
              <Content filterName={this.props.filterName} filters={this.props.filters} handleChange={this.handleChange} labelDot={this.props.labelDot} TooltipTheme='light' tooltips={this.props.tooltips} />
