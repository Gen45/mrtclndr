...
// HELPERS
import {getExtreme, getTimeRange, today} from './helpers/dates';
// import {isValid} from './helpers/misc';

// LOCAL COMPONENTS
import Header from './components/Header';
import ToolBar from './components/ToolBar/ToolBar';
import {MonthBar, MonthLines} from './components/MonthLines';
import EventsWrapper from './components/Event/EventsWrapper';
import Sidebar from './components/Sidebar/Sidebar';
import Modal, {OpenModal} from './components/Helpers/Modal';
...
class App extends Component {
  ...
  handleOpenModal = (targetId) => {
    this.setState(OpenModal(targetId, this.state.events));
  }
  ...
  render(props) {
    ...
    return (<div className={appClass()}>
      ...
      <Sidebar regions={this.state.regions} brands={this.state.brands} offers={this.state.offers} channels={this.state.channels} updateFilter={this.updateFilter} collapsed={this.state.collapsed} stateUpdate={this.stateUpdate}/>
    </div>);
  }
}
